...
priest spell list, and they must be first level or higher.
...
| Sacrifice heart of huge monster   | 1d4 * 1000   |
+-----------------------------------+--------------+
...
| Murder                        | 2d20 * 1000 |
| Forbidden Act(Deity specific) |  1d6 * 1000 |
...
+-----------+-----------------------+------------------------+--------------------------------------+
[1]: Spell is found in spell compendium Volume 1
```
...
disadvantage on their attack. On a failure, they cover their eyes instead of
making that attack.
```
...
- Mirage: The sphere shows what is on the opposite side, seemingly invisible from a distance.
...
of 8 and 1 hit point. Once it tells you about what it saw, it disappears. At the end of the duration, it disappears.
```
...
are judging them for. Each creature can be judged for one sin only once.
+-------------------------------+----------------+
|          Sins                 | Radiant Damage |
+-------------------------------+----------------+
...
Components: V, S
Duration: Instantaneous
You declare that an evil creature within range that can hear and understand you is cursed.
...
Roll for both curse, remedy, and temporary remedy.
1d6 Curse
...
2   Kiss a particular stranger for the first time without any warning.
...
Components: V, S
Duration: Concentration, up to 10 minutes
Your body is bathed in holy light, and you transform. You may select three below:
features of your transformation, which end after the duration.
...
- Rainbow bow: A bow appears in your hands made of multicolored light. It deals 2d10 radiant damage on a hit.
...
Components: V, S, M()
Duration: Instantaneous
You destroy an object of great value
```
