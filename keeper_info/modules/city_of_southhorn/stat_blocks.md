...
`HP: 9(3d4)`: Hit points. First is a prerolled, second is a formula for rolling randomly.
`AC: 12`: Armor class
...
## Humanoids
### Bandits
`Petty Bandit, XP: 25, HP: 4(1d4+1), AC: 11, [12, 12, 12, 10, 12, 12], Dagger +2 1d4+1 piercing, Sling +2 1d4+1 bludgeoning`
`Bandit Militia, XP: 25, HP: 4(1d4+1), AC: 16(Scale Mail), [12, 12, 12, 10, 12, 12], Dagger +2 1d4+1 piercing, Light Crossbow +2 1d8+1 piercing`
`Bandit, XP: 50, HP: 8(2d4+2), AC: 12(leather), [14, 12, 12, 10, 12, 12], Shortsword +4 1d6+2 piercing, Shortbow +4 1d6+1 piercing`

`Bandit Captain, XP: 100, HP: 21(3d8+6), AC: 13(hide), [16, 12, 12, 10, 12, 16], Shortsword +5 1d6+3 piercing`
- Multiattack: Captain can make two shortsword attacks

`Raider, XP: 25, HP: 10(2d6+2), AC: 12(leather), [14, 12, 12, 10, 12, 12], Longsword +4 1d8+2 piercing, Heavy Crossbow +4 1d10+2 piercing`
`Goblin Cannibals, XP: 10, HP: 4(1d4+1), AC: 11, [8, 12, 12, 10, 10, 10], Bone Dagger +2 1d4+1 piercing, Net +4`
...
`Swashbuckler, XP: 25, HP: 8(2d4+2), AC: 12(leather), [14, 12, 12, 10, 12, 12], Scimitar +4 1d6+2 piercing, Pistol(30/60) +3 1d10+1 piercing`

### Cultists
`Cultist Initiate, XP: 25, HP: 3(1d4), AC: 12(leather), [10, 12, 11, 12, 8, 14], Dagger: +2 1d4+1 piercing, Skin Boil(5ft): DC 12 Con save or 1d10 necrotic`
`Prisoner, XP: 0, HP: 3(1d4), AC: 10, [10, 10, 10, 10, 10, 10], Unarmed +1 1 bludgeoning`
...
`Cultist spy, XP: 50, HP: 6(2d4), AC: 14(studded leather), [12, 16, 14, 13, 14, 16], Hidden Dagger: +5 1d4+2 piercing`
- False Life(Bonus action, 1 use): Gain 10(2d8) temp HP
- Force Choke(15ft): +5 1d8 bludgeoning DC 14 STR save or grappled


### Mercenaries
`Hine's Hardback, XP: 25, HP: 8(2d4+2), AC: 12(leather), [14, 12, 12, 10, 12, 12], Longsword +4 1d8+2 piercing, Shortbow +3 1d6+1 piercing`
`Baldric Battleaxe, XP: 100, HP: 18(3d6+6), AC: 17(Scale Mail, shield), Speed: 25ft, [16, 12, 14, 10, 10, 10], Battleaxe +5 1d10+4 slashing`
`Ace, XP: 50, HP: 8(2d4+2), AC: 14(leather), [12, 16, 12, 10, 12, 12], Dagger +6 1d4+3 piercing, Heavy Crossbow +6 1d10+3 piercing`
`Terra, XP: 25, HP: 4(1d4+1), AC: 11, [12, 12, 12, 10, 12, 12], Dagger +2 1d4+1 piercing, Sling +2 1d4+1 bludgeoning`
`Captain Falclind, XP: 200, HP: 21(3d8+6), AC: 13(hide), [16, 12, 12, 10, 12, 16], Rapier +5 1d8+3 piercing, Pistol(30/60) +3 1d10+1`
- Multiattack: Captain can make two rapier attacks

`Paako the brave, XP: 25, HP: 12(3d4+3), AC: 13(leather), Speed: 40ft, [12, 16, 12, 10, 13, 12]`
...
### Misc
`Red Paw, XP: 10, HP: 5(1d6), AC: 11, [14, 14, 12, 12, 12, 12], Claws +2 1d4+1 bludgeoning`
`Crown Guard, XP: 25, HP: 5(1d6+1), AC: 11(padded), [14, 10, 12, 10, 13, 12], Club +3 1d4+2`
`Priest Garris, XP: 100, HP: 3(1d4), AC: 12, [12, 12, 10, 13, 16, 12], Dagger: +2 1d4+1 piercing`
...
## Undead
`Zombie, XP: 25, HP: 10(2d4+4), AC: 8, [14, 8, 14, 4, 4, 4], Bash +2 1d8+1 bludgeoning`
...
`titan Guardian, XP: 100, HP: 26(5d6+6), AC: 16 (chain mail), Speed: 25ft, [17, 8, 14, 4, 4, 4], Battleaxe +5 1d8+3`
...
`Swarm of Leech Crawlers, XP: 50, HP: 15(3d8), AC: 8, [10, 12, 12, 10, 10, 10], Resistance: physical damage`
...
`Hell Knight, XP: 450, HP: 48 (5d12+3), AC: 16(Half Plate), [20, 12, 12, 4, 4, 4]. Blood Sword +6 2d8+5 slashing damage`
...
`Leech dog zombie, XP: 50, HP: 9(3d4), AC: 12, [12, 12, 12, 3, 14, 3], Bite +3 1d4+2 piercing`
...
`Grinder, XP: 100, HP: 26(4d8+6), AC: 14, [16, 10, 14, 10, 10, 10], Slam +4 1d6+3 bludgeoning, Bite +4 1d8+3 piercing`
...
`Leech crawler Noble zombie, XP: 100, HP: 13(3d4+4), AC: 15(Half plate), [14, 14, 18, 10, 8, 10], Unarmed: +3 3 bludgeoning, Rapier: +3 1d8+2 piercing`
- Swarm: Upon death, a swarm of leech crawlers burst from the zombie's body, ready to exact revenge.
...
`Roth'tanag, XP: 700, HP: 45 (10d6+6), AC: 13(Natural Armor), [18, 8, 14, 10, 8, 14]`
...
`Possessed Laria, XP: 100, HP: 3(1d4), AC: 12, spider climb 30ft, [18, 14, 10, 10, 8, 10], Unarmed: +5 5 bludgeoning`
...
`Leech crawler Assassin, XP: 25 HP: 13(3d4+4), AC: 10, Speed: 30ft, [14, 10, 18, 10, 8, 10], Unarmed: +3 3 bludgeoning, Poison dagger +1 1d4+1 piercing + 2d8 poison`
- Swarm: Upon death, a swarm of leech crawlers burst from the zombie's body, ready to exact revenge.


## Construct
`Animated Sword, XP: 50, HP: 15(3d8), AC: 16, Speed: 30 fly, [12, 10, 10, 4, 4, 4], Slash +3 1d8+1 slashing`

## Monstrosity

A lion with tentacles on its back and tail. It has a third eye with a golden iris.

`Mature Blink Lion, Size: large, XP: 450, HP: 41(5d12+6), AC: 12, Speed: 40ft, [15, 14, 14, 4, 10, 4], Claws +5 1d6+2 slashing, Tentacles +5 1 piercing, instant grapple, Tail +5 1d4 piercing, instant grapple`
...
`Blue Slime, Size: Small, XP: 25, HP: 19(3d8+4), AC: 10, [16, 10, 14, 10, 10, 10], Smother +4 1d6+2 acid damage.`
...
`River Giant, size: large, HP: 56(8d12), AC: 12, Speed: 35ft, swim 30ft, [18, 10, 10, 8, 12, 4], Net +4 Succeed a DC 14 STR save or be restrained and grappled, Spear +4 2d8+4 piercing`