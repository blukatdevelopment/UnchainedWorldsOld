from uw.character import parse_character, load_active_character, load_active_status, init_status, save_status, update_hp, format_status
import json
...
def status_commands(bot, discord):
    ...
    async def hp(ctx, change: int):
        result = update_hp(ctx, bot, change)
